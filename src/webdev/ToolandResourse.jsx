...
const ToolandResourseDocumentation = () => {
  ...
  const ToolandResourseContent = {
    title: "Tools AND Resources",
    definition: "Tools and resources are essential for frontend development, providing the necessary support for building and maintaining web applications.",
    importance: [
      "Enhances productivity and efficiency",
      "Provides access to a wealth of knowledge",
          ...
          <div className="p-3 sm:p-4 lg:p-6 max-w-5xl mx-auto">
            ...
            <div className="mb-10 lg:mb-16">
              ...
              <div className="p-6 bg-slate-800/50 rounded-2xl border border-slate-700/50 backdrop-blur-sm">
                <p className="text-lg lg:text-xl text-slate-300 leading-relaxed">
                  {ToolandResourseContent.definition}
                </p>
              </div>
            </div>
            ...
            <div className="mb-12 lg:mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {ToolandResourseContent.importance.map((point, index) => (
            ...
            <div className="mb-12 lg:mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {ToolandResourseContent.whatYouLearn.map((skill, index) => (
                  <div key={index} className="group">
...
export default ToolandResourseDocumentation;