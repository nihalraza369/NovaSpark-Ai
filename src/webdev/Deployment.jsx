...
const DeploymentDocumentation = () => {
  ...
  const DeploymentContent = {
    ...
    definition: "Deployment and DevOps involve preparing applications for production environments, ensuring they run smoothly and efficiently.",
    importance: [
          ...
          <div className="p-3 sm:p-4 lg:p-6 max-w-5xl mx-auto">
            ...
            <div className="mb-12 lg:mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {DeploymentContent.importance.map((point, index) => (
            ...
            <div className="mb-12 lg:mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {DeploymentContent.whatYouLearn.map((skill, index) => (
                  <div key={index} className="group">
