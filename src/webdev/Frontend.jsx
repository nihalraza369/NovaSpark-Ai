...
const FrontendDocumentation = () => {
  ...
  const frontendContent = {
    ...
    definition: "Frontend development involves creating the user-facing part of websites and applications. It encompasses everything users see and interact with in their web browsers.",
    importance: [
