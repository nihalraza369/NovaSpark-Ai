...
const BackendDocumentation = () => {
  ...
  const BackendContent = {
    ...
    definition: "Backend development involves creating the server-side logic and database interactions for web applications. It encompasses everything that happens on the server and ensures that the frontend has the data it needs.",
    importance: [
          ...
          <div className="p-3 sm:p-4 lg:p-6 max-w-5xl mx-auto">
            ...
            <div className="mb-12 lg:mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {BackendContent.importance.map((point, index) => (
            ...
            <div className="mb-12 lg:mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {BackendContent.whatYouLearn.map((skill, index) => (
                  <div key={index} className="group">
